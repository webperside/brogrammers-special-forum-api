...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.webperside.brogrammersspecialforum.controller"))
    ...
    private List<SecurityReference> defaultAuth() {
        ...
        return Collections.singletonList(new SecurityReference("API Token", authorizationScopes));
    }
